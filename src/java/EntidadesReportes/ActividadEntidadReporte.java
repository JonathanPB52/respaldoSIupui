 ...
 * @author Jonathan
 */
public class ActividadEntidadReporte {
    
    public void DescargarActividad(String ruta, String NombreCurso) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        Connection conexion;
        Class.forName("com.mysql.jdbc.Driver").newInstance();
        conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/upui", "UPUI", "1234");
        Map parametro = new HashMap();
        parametro.put("NombreCurso", NombreCurso);
        ...
        try {
            ...
            respuesta.addHeader("content-disposition", "attachment; filename=ActividadReporte.pdf");
