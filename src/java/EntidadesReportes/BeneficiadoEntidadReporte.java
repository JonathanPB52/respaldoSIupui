 ...
 * @author Jonathan
 */
public class BeneficiadoEntidadReporte {
    
    public void DescargarBeneficiado(String ruta, int comedor) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        Connection conexion;
        Class.forName("com.mysql.jdbc.Driver").newInstance();
        conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/upui", "UPUI", "1234");
        Map parametro = new HashMap();
        parametro.put("comedor", comedor);
        ...
        try {
            ...
            respuesta.addHeader("content-disposition", "attachment; filename=BeneficiadoReporte.pdf");
