 ...
 * @author Jonathan
 */
public class DonacionEntidadReporte {
    
    public void DescargarDonacion(String ruta, String TipoDeDonacion) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        Connection conexion;
        Class.forName("com.mysql.jdbc.Driver").newInstance();
        conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/upui", "UPUI", "1234");
        Map parametro = new HashMap();
        parametro.put("TipoDeDonacion", TipoDeDonacion);
        ...
        try {
            ...
            respuesta.addHeader("content-disposition", "attachment; filename=DonacionReporte.pdf");
