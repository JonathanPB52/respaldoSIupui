 ...
 * @author Jonathan
 */
public class DonanteEntidadReporte {
    
    public void DescargarDonante(String ruta, String TipoDeTelefono) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        Connection conexion;
        Class.forName("com.mysql.jdbc.Driver").newInstance();
        conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/upui", "UPUI", "1234");
        Map parametro = new HashMap();
        parametro.put("TipoDeTelefono", TipoDeTelefono);
        ...
        try {
            ...
            respuesta.addHeader("content-disposition", "attachment; filename=DonanteReporte.pdf");
