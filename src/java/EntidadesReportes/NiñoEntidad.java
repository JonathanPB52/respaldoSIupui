 ...
 * @author Jonathan
 */
public class NiñoEntidad {
    
    
    public void DescargarNiños(String ruta, String NombreCurso) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        Connection conexion;
        ...
        try {
            ...
            respuesta.addHeader("content-disposition", "attachment; filename=NiñoReporte.pdf");
