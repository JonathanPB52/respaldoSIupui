 ...
 * @author Jonhy
 */
public class UsuarioEntidadReporte {

    public void DescargarUsuarios(String ruta, String Rol) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        Connection conexion;
        Class.forName("com.mysql.jdbc.Driver").newInstance();
        conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/upui", "UPUI", "1234");
        Map parametro = new HashMap();
        parametro.put("Rol", Rol);
        ...
        try {
            ...
            respuesta.addHeader("content-disposition", "attachment; filename=UsuarioReporte.pdf");
